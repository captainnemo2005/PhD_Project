...
public class Controller {
    ...
    /* CLASS VARIABLES */
    LinkedList<Event> schedule;     // storing the queue for the system Event can be people
    ...
    public Controller(double lambda, double ts, double endTime) {
        ...
        nextArrival = exponential(lambda);			// arrival time at initial is exponential distributed
        nextDeparture = Double.POSITIVE_INFINITY;  //set the next departure time to infinity
    ...
    /* Markow exponetial distribution methods */
